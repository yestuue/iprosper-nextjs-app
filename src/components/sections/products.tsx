...
const ProductsSection = () => {
  ...
  const testimonials = [
  {
    ...
    avatar: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/7faa4423-29cc-4b27-a117-d33c42640a6e/generated_images/professional-business-headshot-of-sarah--04fa51d4-20250904201043.jpg?"
  },
  {
    name: "Mike Rodriguez",
    ...
    avatar: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/7faa4423-29cc-4b27-a117-d33c42640a6e/generated_images/professional-business-headshot-of-mike-r-40937204-20250904201055.jpg?"
  },
  {
    name: "Lisa Chen",
    ...
    avatar: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/7faa4423-29cc-4b27-a117-d33c42640a6e/generated_images/professional-business-headshot-of-lisa-c-4674f7b2-20250904201110.jpg?"
  }];
    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-16 text-white">Key Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) =>
            <Card key={index} className="bg-[#2a2a2a] border-white/10 hover:border-white/20 transition-all duration-300">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-16 text-white">Transform Your Business</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {businessBenefits.map((benefit, index) =>
            <Card key={index} className="group relative overflow-hidden bg-[#2a2a2a] border-white/10 hover:border-white/20 transition-all duration-300">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-16 text-white">Try Our Demo Agents</h2>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-4 text-white">Proven Results</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div key={index} className="text-center">
                ...
                <div className="text-neutral-400">{stat.industry}</div>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-16 text-white">Why Choose iProsper.io</h2>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <h2 className="text-5xl font-semibold text-center mb-16 text-white">What Our Customers Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) =>
            <Card key={index} className="bg-[#2a2a2a] border-white/10">
                <CardContent className="p-8">
                  ...
                  <blockquote className="text-lg mb-6 italic text-white">"{testimonial.quote}"</blockquote>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-400">{testimonial.title}, {testimonial.company}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-5xl font-semibold mb-6 text-white">Ready to Transform Your Business?</h2>
